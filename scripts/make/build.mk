...
define build_binary
	CGO_ENABLED=0 GOOS=$(1) GOARCH=$(2) go build -ldflags="-s -w -X github.com/GoogleCloudPlatform/khi/pkg/common/constants.VERSION=$(VERSION)" -o ./bin/khi-$(2)-$(1)$(3) ./cmd/kubernetes-history-inspector/...
endef
