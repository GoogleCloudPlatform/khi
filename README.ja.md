...
[![Kubernetes History Inspector Demo](./docs/images/thumbnail.png)](https://github.com/user-attachments/assets/2a735154-1684-4575-a18d-177c012e1a09)
...
最も手軽に試すには、メタデータサーバが利用可能な [Cloud Shell](https://shell.cloud.google.com) での実行がおすすめです（認証情報の事前設定が不要です）。
...
### メタデータサーバが利用できない環境（ローカル PC 環境等）で実行する場合
