...
var OnPremCloudAuditLogParseTask = parser.NewParserTaskFromParser(gcp_task.GCPPrefix+"feature/onprem-audit-parser", &onpremCloudAuditLogParser{}, true, inspectiontype.GDCClusterInspectionTypes)
