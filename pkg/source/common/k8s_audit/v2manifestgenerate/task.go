...
var Task = inspection_task.NewInspectionProcessor(constants.ManifestGenerateTaskID, []string{
	inspection_task.ReaderFactoryGeneratorTaskID,
	constants.TimelineGroupingTaskID,
	...
	groups, err := task.GetTypedVariableFromTaskVariable[[]*types.TimelineGrouperResult](v, constants.TimelineGroupingTaskID, nil)
	if err != nil {
		return nil, err
	}
