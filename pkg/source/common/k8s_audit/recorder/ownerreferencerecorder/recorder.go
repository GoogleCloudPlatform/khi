...
func Register(manager *recorder.RecorderTaskManager) error {
	manager.AddRecorder("owner-references", []string{}, func(ctx context.Context, resourcePath string, currentLog *types.AuditLogParserInput, prevStateInGroup any, cs *history.ChangeSet, builder *history.Builder, vs *task.VariableSet) (any, error) {
