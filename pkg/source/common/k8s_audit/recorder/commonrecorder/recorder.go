...
func Register(manager *recorder.RecorderTaskManager) error {
	manager.AddRecorder("common", []string{}, func(ctx context.Context, resourcePath string, l *types.AuditLogParserInput, prevState any, cs *history.ChangeSet, builder *history.Builder, vs *task.VariableSet) (any, error) {
