...
var Task = inspection_task.NewInspectionProcessor(constants.TimelineGroupingTaskID, []string{
	constants.CommonLogParseTaskID,
	...
	preStepParseResult, err := task.GetTypedVariableFromTaskVariable[[]*types.AuditLogParserInput](v, constants.CommonLogParseTaskID, nil)
	if err != nil {
		return nil, err
	}
