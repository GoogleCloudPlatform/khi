...
func TestWhereFieldEquals(t *testing.T) {
	...
	t.Run("includeIfMissing=false", func(t *testing.T) {
		predicate := WhereFieldEquals(getMap, key, "red", false)
		result := Filter(items, predicate)
	...
	t.Run("includeIfMissing=true", func(t *testing.T) {
		predicate := WhereFieldEquals(getMap, key, "red", true)
		result := Filter(items, predicate)
...
func TestWhereFieldContainsElement(t *testing.T) {
	...
	getMap := func(s testStruct) *ReadonlyTypedMap { return s.labels }
	t.Run("includeIfMissing=false", func(t *testing.T) {
		predicate := WhereFieldContainsElement(getMap, key, "a", false)
		result := Filter(items, predicate)
	...
	t.Run("includeIfMissing=true", func(t *testing.T) {
		predicate := WhereFieldContainsElement(getMap, key, "a", true)
		result := Filter(items, predicate)
...
func TestWhereFieldIsEnabled(t *testing.T) {
	...
	getMap := func(s testStruct) *ReadonlyTypedMap { return s.labels }
	t.Run("includeIfMissing=false", func(t *testing.T) {
		predicate := WhereFieldIsEnabled(getMap, key, false)
		result := Filter(items, predicate)
	...
	t.Run("includeIfMissing=true", func(t *testing.T) {
		predicate := WhereFieldIsEnabled(getMap, key, true)
		result := Filter(items, predicate)
