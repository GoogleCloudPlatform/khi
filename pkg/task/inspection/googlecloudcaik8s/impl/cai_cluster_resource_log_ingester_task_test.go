...
func TestRawLogTask(t *testing.T) {
	...
	snapshotWithResourceData := &googlecloudcaik8s_contract.ClusterResourceSnapshot{
		StartTime: testTime,
	...
	snapshotWithoutResourceData := &googlecloudcaik8s_contract.ClusterResourceSnapshot{
		StartTime: testTime,
		TemporalAsset: &assetpb.TemporalAsset{
			Asset: &assetpb.Asset{
	...
	deletedSnapshotWithWindow := &googlecloudcaik8s_contract.ClusterResourceSnapshot{
		StartTime: testTime,
		TemporalAsset: &assetpb.TemporalAsset{
	...
	snapshotWithoutTypeMeta := &googlecloudcaik8s_contract.ClusterResourceSnapshot{
		StartTime: testTime,
		TemporalAsset: &assetpb.TemporalAsset{
			Asset: &assetpb.Asset{
	...
	snapshotWithEncodedMetadata := &googlecloudcaik8s_contract.ClusterResourceSnapshot{
		StartTime: testTime,
		TemporalAsset: &assetpb.TemporalAsset{
			Asset: &assetpb.Asset{
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			got, _, err := inspectiontest.RunInspectionTask(ctx, RawLogTask, tc.taskMode, map[string]any{},
				tasktest.NewTaskDependencyValuePair(googlecloudcaik8s_contract.ClusterResourceFetcherTaskID.Ref(), tc.snapshots),
			)
			if err != nil {
