...
func newTestGKESnapshot(t *testing.T, params gkeSnapshotParams) *googlecloudcaik8s_contract.GKEResourceSnapshot {
	t.Helper()
	...
	return &googlecloudcaik8s_contract.GKEResourceSnapshot{
...
func TestCAIGKEInitialResourceStateProvider(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			snapshots := make([]*googlecloudcaik8s_contract.GKEResourceSnapshot, 0, len(tc.snapshots))
