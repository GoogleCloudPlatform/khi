...
func snapshotToRawLog(idGen *id.Generator, s *googlecloudcaik8s_contract.ClusterResourceSnapshot) (*log.Log, error) {
...
var RawLogTask = inspectiontaskbase.NewInspectionTask(
	...
	func(ctx context.Context, taskMode inspectioncore.InspectionTaskModeType) ([]*log.Log, error) {
		...
		snapshots := coretask.GetTaskResult(ctx, googlecloudcaik8s_contract.ClusterResourceFetcherTaskID.Ref())
...
func (i *caiClusterResourceLogIngester) RawLogTask() taskid.TaskReference[[]*log.Log] {
	return googlecloudcaik8s_contract.RawLogTaskID.Ref()
}
...
var LogIngesterTask = inspectiontaskbase.NewLogIngesterTask(
	googlecloudcaik8s_contract.LogIngesterTaskID,
...
var LogGrouperTask = inspectiontaskbase.NewLogGrouperTask(
	googlecloudcaik8s_contract.LogGrouperTaskID,
