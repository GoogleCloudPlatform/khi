...
`)
			...
			result, _, err := inspectiontest.RunInspectionTask(
				...
				tasktest.NewTaskDependencyValuePair[commonlogk8saudit_contract.InitialResourceStateProvider](commonlogk8saudit_contract.InitialResourceStateProviderRef, &emptyInitialResourceStateProvider{}),
			)
			if err != nil {
