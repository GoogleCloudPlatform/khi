...
func processEndpointSliceResource(ctx context.Context, group *commonlogk8saudit_contract.ResourceManifestLogGroup, leaseHistory commonlogk8saudit_contract.IPLeaseHistory) {
	for _, l := range group.Logs {
		if l.ResourceBodyReader == nil {
			continue
		}
