...
func TestIPLeaseHistoryDiscoveryTassk(t *testing.T) {
	...
	testCases := []struct {
		desc            string
		inputResource   *commonlogk8saudit_contract.ResourceIdentity
  ...
  - addresses:
	...
	for _, test := range testCases {
		t.Run(test.desc, func(t *testing.T) {
			...
			input := commonlogk8saudit_contract.ResourceManifestLogGroupMap{}
			input["test"] = &commonlogk8saudit_contract.ResourceManifestLogGroup{
