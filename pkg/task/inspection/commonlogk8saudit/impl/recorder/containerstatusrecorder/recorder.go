...
func recordChangeSetForLog(ctx context.Context, resourcePath string, l *commonlogk8saudit_contract.AuditLogParserInput, prevPodStatus *corev1.Pod, cs *history.ChangeSet, builder *history.Builder) (*corev1.Pod, error) {
