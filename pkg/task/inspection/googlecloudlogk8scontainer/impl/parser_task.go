...
var LogIngesterTask = inspectiontaskbase.NewLogIngester(googlecloudlogk8scontainer_contract.LogIngesterTaskID, googlecloudlogk8scontainer_contract.ListLogEntriesTaskID.Ref())
