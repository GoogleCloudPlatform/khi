...
func TestNewFormTaskBuilderBase(t *testing.T) {
	...
	builder := NewFormTaskBuilderBase(testID, testPriority, testLabel)

	if builder.id != testID {
...
func TestFormTaskBuilderBase_WithDescription(t *testing.T) {
	builder := NewFormTaskBuilderBase("test-id", 1, "Test Label")
...
func TestFormTaskBuilderBase_WithDependencies(t *testing.T) {
	builder := NewFormTaskBuilderBase("test-id", 1, "Test Label")
	testDependencies := []string{"dep1", "dep2", "dep3"}
