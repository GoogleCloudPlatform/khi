...
func TestApiResponses(t *testing.T) {
	...
	scenarioSteps := []testScenarioStep{
		...
		},
		{
			...
			BodyValidator: metadataIgnoredBodyCompare(`{"metadata":{"form":[{"default":"","description":"","hint":"","hintType":"none","id":"foo-input","label":"A input field for foo","readonly":false,"suggestions":null,"type":"text","validationTiming":"onchange"}],"query":[]}}`, "plan"),
		},
		{
			// 008
		...
		},
		{
			...
			BodyValidator: metadataIgnoredBodyCompare(`{"metadata":{"form":[{"default":"","description":"","hint":"invalid value","hintType":"error","id":"foo-input","label":"A input field for foo","readonly":false,"suggestions":null,"type":"text","validationTiming":"onchange"}],"query":[]}}`, "plan"),
		},
		{
			// 010
