...
func TestLogToTimelineMapperV2Task(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			_, _, err := inspectiontest.RunInspectionTask(ctx, task, tc.taskMode, map[string]any{}, tasktest.NewTaskDependencyValuePair(mockLogLogToTimelineMapperV2PrevTaskID(), prevGroupMap))
...
func mockLogLogToTimelineMapperV2PrevTaskID() taskid.TaskReference[LogGroupMap] {
	return mockLogToTimelineMapperV2PrevTaskID.Ref()
}
