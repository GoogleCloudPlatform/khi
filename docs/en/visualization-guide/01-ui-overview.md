...
[< Previous: Introduction](./00-introduction.md) | [Next: Startup and Inspections >](./02-startup-and-inspections.md)
...
| **Topology view layout** | `Ctrl+3` / `Cmd+3` | Timeline View + Graph View | Specialized layout for inspecting resource dependencies and parent-child relationships at specific points in time. |
